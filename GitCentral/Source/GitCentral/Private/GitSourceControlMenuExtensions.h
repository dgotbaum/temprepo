...
class FGitSourceControlMenuExtensions /*: public TSharedFromThis<FGitSourceControlMenuExtensions>*/
{
public:
...
private:
	...
	void AddSourceControlMenuExtension(FMenuBuilder& MenuBuilder) const;
	void AddAssetContextMenuExtension(FMenuBuilder& MenuBuilder) const;
