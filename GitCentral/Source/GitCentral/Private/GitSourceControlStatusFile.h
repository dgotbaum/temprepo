...
public:
	...
	bool Save(const FString& PathToRepositoryRoot);
	...
	bool SetState(const FString& InFilePath, const SavedState& InState, const FString& PathToRepositoryRoot, bool bDoNotSave = false);
	bool ClearState(const FString& InFilePath, const FString& PathToRepositoryRoot, bool bDoNotSave = false);
