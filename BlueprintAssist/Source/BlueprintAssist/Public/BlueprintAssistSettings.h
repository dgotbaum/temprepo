...
struct FBAFormatterSettings
{
	...
	UPROPERTY(EditAnywhere, config, Category = FormatterSettings)
	TEnumAsByte<EBAAutoFormatting> AutoFormatting = BAAutoFormat_FormatAllConnected;
};
...
public:
	...
	/* Use comment bubble width when calculating the size of nodes */
	UPROPERTY(EditAnywhere, config, Category = FormattingOptions)
	bool bUseCommentBubbleWidth;
	...
	/* Automatically insert nodes into comment boxes */
	UPROPERTY(EditAnywhere, config, Category = General)
