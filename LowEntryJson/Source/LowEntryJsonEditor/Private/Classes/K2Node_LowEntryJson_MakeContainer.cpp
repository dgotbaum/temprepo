...
void FKCHandler_LowEntryJson_MakeContainer::RegisterNets(FKismetFunctionContext& Context, UEdGraphNode* Node)
{
	UK2Node_LowEntryJson_MakeContainer* ContainerNode = CastChecked<UK2Node_LowEntryJson_MakeContainer>(Node);
...
void FKCHandler_LowEntryJson_MakeContainer::Compile(FKismetFunctionContext& Context, UEdGraphNode* Node)
{
	UK2Node_LowEntryJson_MakeContainer* ContainerNode = CastChecked<UK2Node_LowEntryJson_MakeContainer>(Node);
	UEdGraphPin* OutputPin = ContainerNode->GetOutputPin();
...
/////////////////////////////////////////////////////
// UK2Node_LowEntryJson_MakeContainer

UK2Node_LowEntryJson_MakeContainer::UK2Node_LowEntryJson_MakeContainer(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	NumInputs = 1;
}

UEdGraphPin* UK2Node_LowEntryJson_MakeContainer::GetOutputPin() const
{
	return FindPin(GetOutputPinName());
}

void UK2Node_LowEntryJson_MakeContainer::ReallocatePinsDuringReconstruction(TArray<UEdGraphPin*>& OldPins)
{
...
void UK2Node_LowEntryJson_MakeContainer::AllocateDefaultPins()
{
...
void UK2Node_LowEntryJson_MakeContainer::GetKeyAndValuePins(TArray<UEdGraphPin*>& KeyPins, TArray<UEdGraphPin*>& ValuePins) const
{
...
bool UK2Node_LowEntryJson_MakeContainer::CanResetToWildcard() const
{
...
void UK2Node_LowEntryJson_MakeContainer::ClearPinTypeToWildcard()
{
...
void UK2Node_LowEntryJson_MakeContainer::NotifyPinConnectionListChanged(UEdGraphPin* Pin)
{
...
void UK2Node_LowEntryJson_MakeContainer::PropagatePinType()
{
...
void UK2Node_LowEntryJson_MakeContainer::PostReconstructNode()
{
...
void UK2Node_LowEntryJson_MakeContainer::InteractiveAddInputPin()
{
	FScopedTransaction Transaction(LOCTEXT("AddPinTx", "Add Pin"));
	AddInputPin();
}

void UK2Node_LowEntryJson_MakeContainer::AddInputPin()
{
	Modify();
...
FName UK2Node_LowEntryJson_MakeContainer::GetPinName(const int32 PinIndex) const
{
	return *FString::Printf(TEXT("[%d]"), PinIndex);
}

void UK2Node_LowEntryJson_MakeContainer::SyncPinNames()
{
...
void UK2Node_LowEntryJson_MakeContainer::RemoveInputPin(UEdGraphPin* Pin)
{
...
void UK2Node_LowEntryJson_MakeContainer::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
bool UK2Node_LowEntryJson_MakeContainer::IsConnectionDisallowed(const UEdGraphPin* MyPin, const UEdGraphPin* OtherPin, FString& OutReason) const
{
	if(!ensure(OtherPin))
	{
		return true;
