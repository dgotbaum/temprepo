...
// init >>
	...
	ULowEntryJsonObject* ULowEntryJsonObject::CreateUnsafe(const TSharedPtr<FJsonObject> Value)
	{
		ULowEntryJsonObject* Instance = NewObject<ULowEntryJsonObject>();
		if(Value.IsValid())
		{
...
bool ULowEntryJsonObject::FJsonObjectEquals(FJsonObject* ObjectA, FJsonObject* ObjectB)
{
	if(ObjectA == nullptr)
	{
		return (ObjectB == nullptr);
	}
	if(ObjectB == nullptr)
	{
		return false;
	...
	TArray<FString> KeysA = TArray<FString>();
	KeysA.Reserve(ObjectA->Values.Num());
	ObjectA->Values.GetKeys(KeysA);
	for(const FString& Key : KeysA)
	{
		if(!ULowEntryJsonValue::FJsonValueEquals(ObjectA->TryGetField(Key).Get(), ObjectB->TryGetField(Key).Get()))
		{
			return false;
		}
	}
...
bool ULowEntryJsonObject::Equals(ULowEntryJsonObject* JsonObjectA, ULowEntryJsonObject* JsonObjectB)
{
	if(JsonObjectA == nullptr)
	{
		return (JsonObjectB == nullptr);
	}
	if(JsonObjectB == nullptr)
	{
		return false;
	}
	return ULowEntryJsonObject::FJsonObjectEquals(JsonObjectA->Data.Get(), JsonObjectB->Data.Get());
}
...
void ULowEntryJsonObject::SetJsonObjectUnsafe(ULowEntryJsonObject* JsonObject, const FString& Key, ULowEntryJsonObject* Value)
{
	if(JsonObject == nullptr)
	{
		return;
	...
	if(Value != nullptr)
	{
		JsonObject->Data->SetObjectField(Key, Value->Data);
	}
	else
	{
		JsonObject->Data->SetField(Key, MakeShareable(new FJsonValueNull()));
...
void ULowEntryJsonObject::SetJsonArrayUnsafe(ULowEntryJsonObject* JsonObject, const FString& Key, ULowEntryJsonArray* Value)
{
	if(JsonObject == nullptr)
	{
		return;
...
void ULowEntryJsonObject::SetJsonValueUnsafe(ULowEntryJsonObject* JsonObject, const FString& Key, ULowEntryJsonValue* Value)
{
	if(JsonObject == nullptr)
	{
		return;
	...
	if(Value != nullptr)
	{
		JsonObject->Data->SetField(Key, Value->Data);
	}
	else
	{
		JsonObject->Data->SetField(Key, MakeShareable(new FJsonValueNull()));
