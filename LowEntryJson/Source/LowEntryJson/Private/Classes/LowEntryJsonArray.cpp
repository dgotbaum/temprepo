...
// init >>
	...
	ULowEntryJsonArray* ULowEntryJsonArray::CreateUnsafe(const TArray<TSharedPtr<FJsonValue>> Value)
	{
		ULowEntryJsonArray* Instance = NewObject<ULowEntryJsonArray>();
		Instance->Data = Value;
		return Instance;
	...
	ULowEntryJsonArray* ULowEntryJsonArray::CreateFromJsonObjectArrayUnsafe(const TArray<ULowEntryJsonObject*>& Value)
	{
		ULowEntryJsonArray* Instance = NewObject<ULowEntryJsonArray>();
		for(int64 i = 0; i < Value.Num(); i++)
		{
			if(Value[i] != nullptr)
			{
				Instance->Data.Add(MakeShareable(new FJsonValueObject(Value[i]->Data)));
			}
		}
		return Instance;
	}
	...
	ULowEntryJsonArray* ULowEntryJsonArray::CreateFromJsonArrayArrayUnsafe(const TArray<ULowEntryJsonArray*>& Value)
	{
		ULowEntryJsonArray* Instance = NewObject<ULowEntryJsonArray>();
		for(int64 i = 0; i < Value.Num(); i++)
		{
	...
	ULowEntryJsonArray* ULowEntryJsonArray::CreateFromJsonValueArrayUnsafe(const TArray<ULowEntryJsonValue*>& Value)
	{
		ULowEntryJsonArray* Instance = NewObject<ULowEntryJsonArray>();
		for(int64 i = 0; i < Value.Num(); i++)
		{
			if(Value[i] != nullptr)
			{
				Instance->Data.Add(Value[i]->Data);
			}
		}
		return Instance;
	}
...
bool ULowEntryJsonArray::Equals(ULowEntryJsonArray* JsonArrayA, ULowEntryJsonArray* JsonArrayB)
{
	if(JsonArrayA == nullptr)
	{
		return (JsonArrayB == nullptr);
	}
	if(JsonArrayB == nullptr)
	{
		return false;
	}
	if(JsonArrayA->Data.Num() != JsonArrayB->Data.Num())
	{
		return false;
	}
	const int64 Length = JsonArrayA->Data.Num();
	for(int64 i = 0; i < Length; i++)
	{
		if(!ULowEntryJsonValue::FJsonValueEquals(JsonArrayA->Data[i].Get(), JsonArrayB->Data[i].Get()))
		{
			return false;
		}
	}
...
void ULowEntryJsonArray::Unset(ULowEntryJsonArray* JsonArray, const int32 Index, const int32 Count)
{
	...
	int64 Length = JsonArray->Data.Num();
	int64 UseIndex = Index;
	int64 UseCount = Count;
	if(UseIndex >= Length)
	{
		return;
	}
...
void ULowEntryJsonArray::AddJsonObjectUnsafe(ULowEntryJsonArray* JsonArray, ULowEntryJsonObject* Value)
{
	if(JsonArray == nullptr)
	{
		return;
	...
	if(Value != nullptr)
	{
		JsonArray->Data.Add(MakeShareable(new FJsonValueObject(Value->Data)));
	}
	else
	{
		JsonArray->Data.Add(MakeShareable(new FJsonValueNull()));
...
void ULowEntryJsonArray::AddJsonArrayUnsafe(ULowEntryJsonArray* JsonArray, ULowEntryJsonArray* Value)
{
	if(JsonArray == nullptr)
	{
		return;
...
void ULowEntryJsonArray::AddJsonValueUnsafe(ULowEntryJsonArray* JsonArray, ULowEntryJsonValue* Value)
{
	if(JsonArray == nullptr)
	{
		return;
...
void ULowEntryJsonArray::SetJsonObjectUnsafe(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonObject* Value)
{
	if(JsonArray == nullptr)
	{
		return;
	...
	if(Value != nullptr)
	{
		JsonArray->Data[Index] = MakeShareable(new FJsonValueObject(Value->Data));
	}
	else
	{
		JsonArray->Data[Index] = MakeShareable(new FJsonValueNull());
...
void ULowEntryJsonArray::SetJsonArrayUnsafe(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonArray* Value)
{
	if(JsonArray == nullptr)
	{
		return;
...
void ULowEntryJsonArray::SetJsonValueUnsafe(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonValue* Value)
{
	if(JsonArray == nullptr)
	{
		return;
	...
	if(Value != nullptr)
	{
		JsonArray->Data[Index] = Value->Data;
	}
	else
	{
		JsonArray->Data[Index] = MakeShareable(new FJsonValueNull());
...
void ULowEntryJsonArray::InsertJsonObjectUnsafe(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonObject* Value)
{
	if(JsonArray == nullptr)
	{
		return;
	...
	if(Value != nullptr)
	{
		JsonArray->Data.Insert(MakeShareable(new FJsonValueObject(Value->Data)), Index);
	}
	else
	{
		JsonArray->Data.Insert(MakeShareable(new FJsonValueNull()), Index);
...
void ULowEntryJsonArray::InsertJsonArrayUnsafe(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonArray* Value)
{
	if(JsonArray == nullptr)
	{
		return;
...
void ULowEntryJsonArray::InsertJsonValueUnsafe(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonValue* Value)
{
	if(JsonArray == nullptr)
	{
		return;
	...
	if(Value != nullptr)
	{
		JsonArray->Data.Insert(Value->Data, Index);
	}
	else
	{
		JsonArray->Data.Insert(MakeShareable(new FJsonValueNull()), Index);
