...
// init >>
	...
	ULowEntryJsonObjectEntry* ULowEntryJsonObjectEntry::CreateFromJsonObjectUnsafe(const FString& Key, ULowEntryJsonObject* Value)
	{
		ULowEntryJsonObjectEntry* Instance = NewObject<ULowEntryJsonObjectEntry>();
		Instance->Key = Key;
		Instance->Value = ULowEntryJsonValue::CreateFromJsonObjectUnsafe(Value);
		return Instance;
	}
	...
	ULowEntryJsonObjectEntry* ULowEntryJsonObjectEntry::CreateFromJsonArrayUnsafe(const FString& Key, ULowEntryJsonArray* Value)
	{
		ULowEntryJsonObjectEntry* Instance = NewObject<ULowEntryJsonObjectEntry>();
		Instance->Key = Key;
		Instance->Value = ULowEntryJsonValue::CreateFromJsonArrayUnsafe(Value);
		return Instance;
	}
// init <<
