...
// init >>
	...
	ULowEntryJsonValue* ULowEntryJsonValue::CreateUnsafe(const TSharedPtr<FJsonValue> Value)
	{
		ULowEntryJsonValue* Instance = NewObject<ULowEntryJsonValue>();
		Instance->Data = Value;
		return Instance;
	...
	ULowEntryJsonValue* ULowEntryJsonValue::CreateFromJsonObjectUnsafe(ULowEntryJsonObject* Value)
	{
		ULowEntryJsonValue* Instance = NewObject<ULowEntryJsonValue>();
		if(Value != nullptr)
		{
			Instance->Data = MakeShareable(new FJsonValueObject(Value->Data));
		}
		else
		{
			Instance->Data = MakeShareable(new FJsonValueNull());
	...
	ULowEntryJsonValue* ULowEntryJsonValue::CreateFromJsonArrayUnsafe(ULowEntryJsonArray* Value)
	{
		ULowEntryJsonValue* Instance = NewObject<ULowEntryJsonValue>();
		if(Value != nullptr)
		{
...
bool ULowEntryJsonValue::FJsonValueEquals(FJsonValue* ValueA, FJsonValue* ValueB)
{
	if(ValueA == nullptr)
	{
		return (ValueB == nullptr);
	}
	if(ValueB == nullptr)
	{
		return false;
	}
	return FJsonValue::CompareEqual(*ValueA, *ValueB);
}

bool ULowEntryJsonValue::Equals(ULowEntryJsonValue* JsonValueA, ULowEntryJsonValue* JsonValueB)
{
	if(JsonValueA == nullptr)
	{
		return (JsonValueB == nullptr);
	}
	if(JsonValueB == nullptr)
	{
		return false;
	}
	return ULowEntryJsonValue::FJsonValueEquals(JsonValueA->Data.Get(), JsonValueB->Data.Get());
}
...
void ULowEntryJsonValue::SetUnsafe(ULowEntryJsonValue* JsonValue, ULowEntryJsonValue* Value)
{
	if(JsonValue == nullptr)
	{
		return;
...
void ULowEntryJsonValue::SetJsonObjectUnsafe(ULowEntryJsonValue* JsonValue, ULowEntryJsonObject* Value)
{
	if(JsonValue == nullptr)
	{
		return;
	...
	if(Value != nullptr)
	{
		JsonValue->Data = MakeShareable(new FJsonValueObject(Value->Data));
	}
	else
	{
		JsonValue->Data = MakeShareable(new FJsonValueNull());
...
void ULowEntryJsonValue::SetJsonArrayUnsafe(ULowEntryJsonValue* JsonValue, ULowEntryJsonArray* Value)
{
	if(JsonValue == nullptr)
	{
		return;
