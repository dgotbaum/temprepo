...
// json >>
	void ULowEntryJsonLibrary::Json_ParseJsonString(const FString& JsonString, ULowEntryJsonObject*& ReturnJsonObjectValue, ULowEntryJsonArray*& ReturnJsonArrayValue, ELowEntryJsonParseResult& Branch)
	{
		...
		if(TrimmedJsonString.StartsWith(TEXT("{")) && TrimmedJsonString.EndsWith(TEXT("}")))
		{
			...
			{
				ReturnJsonObjectValue = ULowEntryJsonObject::CreateUnsafe(JsonObjectData);
				Branch = ELowEntryJsonParseResult::FoundObject;
				return;
			}
		}

		// Parsing arrays doesn't work:
		//if(TrimmedJsonString.StartsWith(TEXT("[")) && TrimmedJsonString.EndsWith(TEXT("]")))
		//{
		//	TSharedRef<TJsonReader<TCHAR>> JsonReader = TJsonReaderFactory<TCHAR>::Create(TrimmedJsonString);
		...
		//	{
		//		ReturnJsonArrayValue = ULowEntryJsonArray::CreateUnsafe(JsonArrayData);
		//		Branch = ELowEntryJsonParseResult::FoundArray;
		//		return;
		//	}
		//}

		// Hotfix for array parsing:
		if(TrimmedJsonString.StartsWith(TEXT("[")) && TrimmedJsonString.EndsWith(TEXT("]")))
		{
...
// object >>
	...
	ULowEntryJsonObject* ULowEntryJsonLibrary::Object_Pure_CreateFromObjectEntryArray_Internal_Safe(const TArray<ULowEntryJsonObjectEntry*>& Array)
	{
		return ULowEntryJsonObject::Create(Array);
	}

	ULowEntryJsonObject* ULowEntryJsonLibrary::Object_Pure_CreateFromObjectEntryArray_Internal_Unsafe(const TArray<ULowEntryJsonObjectEntry*>& Array)
	{
		return ULowEntryJsonObject::Create(Array);
	}
	...
	bool ULowEntryJsonLibrary::Object_Equals(ULowEntryJsonObject* JsonObjectA, ULowEntryJsonObject* JsonObjectB)
	{
		return ULowEntryJsonObject::Equals(JsonObjectA, JsonObjectB);
	}

	bool ULowEntryJsonLibrary::Object_NotEquals(ULowEntryJsonObject* JsonObjectA, ULowEntryJsonObject* JsonObjectB)
	{
		return !ULowEntryJsonObject::Equals(JsonObjectA, JsonObjectB);
	}
	...
	void ULowEntryJsonLibrary::Object_SetJsonObject(ULowEntryJsonObject* JsonObject, const FString& Key, ULowEntryJsonObject* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonObject::SetJsonObjectUnsafe(JsonObject, Key, Value);
			return;
		}
		ULowEntryJsonObject::SetJsonObject(JsonObject, Key, Value);
	}

	void ULowEntryJsonLibrary::Object_SetJsonArray(ULowEntryJsonObject* JsonObject, const FString& Key, ULowEntryJsonArray* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonObject::SetJsonArrayUnsafe(JsonObject, Key, Value);
			return;
		}
		ULowEntryJsonObject::SetJsonArray(JsonObject, Key, Value);
	}

	void ULowEntryJsonLibrary::Object_SetJsonValue(ULowEntryJsonObject* JsonObject, const FString& Key, ULowEntryJsonValue* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonObject::SetJsonValueUnsafe(JsonObject, Key, Value);
			return;
		}
...
// object entry >>
	...
	FString ULowEntryJsonLibrary::ObjectEntry_GetKey(ULowEntryJsonObjectEntry* JsonObjectEntry)
	{
		if(JsonObjectEntry == nullptr)
		{
			return TEXT("");
		}
		return JsonObjectEntry->Key;
	}

	ULowEntryJsonValue* ULowEntryJsonLibrary::ObjectEntry_GetValue(ULowEntryJsonObjectEntry* JsonObjectEntry)
	{
		if(JsonObjectEntry == nullptr)
		{
			return NULL;
		}
		return JsonObjectEntry->Value;
	}
	...
	ULowEntryJsonObjectEntry* ULowEntryJsonLibrary::ObjectEntry_Pure_CreateFromJsonObject(const FString& Key, ULowEntryJsonObject* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			return ULowEntryJsonObjectEntry::CreateFromJsonObjectUnsafe(Key, Value);
		}
		return ULowEntryJsonObjectEntry::CreateFromJsonObject(Key, Value);
	}

	ULowEntryJsonObjectEntry* ULowEntryJsonLibrary::ObjectEntry_Pure_CreateFromJsonArray(const FString& Key, ULowEntryJsonArray* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			return ULowEntryJsonObjectEntry::CreateFromJsonArrayUnsafe(Key, Value);
		}
...
// array >>
	...
	ULowEntryJsonArray* ULowEntryJsonLibrary::Array_CreateFromJsonObjectArray(const TArray<ULowEntryJsonObject*>& Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			return ULowEntryJsonArray::CreateFromJsonObjectArrayUnsafe(Value);
		}
		return ULowEntryJsonArray::CreateFromJsonObjectArray(Value);
	}

	ULowEntryJsonArray* ULowEntryJsonLibrary::Array_CreateFromJsonArrayArray(const TArray<ULowEntryJsonArray*>& Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			return ULowEntryJsonArray::CreateFromJsonArrayArrayUnsafe(Value);
		}
		return ULowEntryJsonArray::CreateFromJsonArrayArray(Value);
	}

	ULowEntryJsonArray* ULowEntryJsonLibrary::Array_CreateFromJsonValueArray(const TArray<ULowEntryJsonValue*>& Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			return ULowEntryJsonArray::CreateFromJsonValueArrayUnsafe(Value);
		}
	...
	ULowEntryJsonArray* ULowEntryJsonLibrary::Array_Pure_CreateFromJsonObjectArray(const TArray<ULowEntryJsonObject*>& Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			return ULowEntryJsonArray::CreateFromJsonObjectArrayUnsafe(Value);
	...
	ULowEntryJsonArray* ULowEntryJsonLibrary::Array_Pure_CreateFromJsonArrayArray(const TArray<ULowEntryJsonArray*>& Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			return ULowEntryJsonArray::CreateFromJsonArrayArrayUnsafe(Value);
	...
	ULowEntryJsonArray* ULowEntryJsonLibrary::Array_Pure_CreateFromJsonValueArray(const TArray<ULowEntryJsonValue*>& Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			return ULowEntryJsonArray::CreateFromJsonValueArrayUnsafe(Value);
	...
	ULowEntryJsonArray* ULowEntryJsonLibrary::Array_Pure_CreateFromJsonValueArray_Internal_Safe(const TArray<ULowEntryJsonValue*>& Value)
	{
		return ULowEntryJsonArray::CreateFromJsonValueArray(Value);
	}

	ULowEntryJsonArray* ULowEntryJsonLibrary::Array_Pure_CreateFromJsonValueArray_Internal_Unsafe(const TArray<ULowEntryJsonValue*>& Value)
	{
		return ULowEntryJsonArray::CreateFromJsonValueArrayUnsafe(Value);
	}
	...
	bool ULowEntryJsonLibrary::Array_Equals(ULowEntryJsonArray* JsonArrayA, ULowEntryJsonArray* JsonArrayB)
	{
		return ULowEntryJsonArray::Equals(JsonArrayA, JsonArrayB);
	}

	bool ULowEntryJsonLibrary::Array_NotEquals(ULowEntryJsonArray* JsonArrayA, ULowEntryJsonArray* JsonArrayB)
	{
		return !ULowEntryJsonArray::Equals(JsonArrayA, JsonArrayB);
	}
	...
	void ULowEntryJsonLibrary::Array_AddJsonObject(ULowEntryJsonArray* JsonArray, ULowEntryJsonObject* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonArray::AddJsonObjectUnsafe(JsonArray, Value);
			return;
		}
		ULowEntryJsonArray::AddJsonObject(JsonArray, Value);
	}

	void ULowEntryJsonLibrary::Array_AddJsonArray(ULowEntryJsonArray* JsonArray, ULowEntryJsonArray* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonArray::AddJsonArrayUnsafe(JsonArray, Value);
			return;
		}
		ULowEntryJsonArray::AddJsonArray(JsonArray, Value);
	}

	void ULowEntryJsonLibrary::Array_AddJsonValue(ULowEntryJsonArray* JsonArray, ULowEntryJsonValue* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonArray::AddJsonValueUnsafe(JsonArray, Value);
			return;
		}
	...
	void ULowEntryJsonLibrary::Array_SetJsonObject(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonObject*  Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonArray::SetJsonObjectUnsafe(JsonArray, Index, Value);
			return;
		}
		ULowEntryJsonArray::SetJsonObject(JsonArray, Index, Value);
	}

	void ULowEntryJsonLibrary::Array_SetJsonArray(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonArray* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonArray::SetJsonArrayUnsafe(JsonArray, Index, Value);
			return;
		}
		ULowEntryJsonArray::SetJsonArray(JsonArray, Index, Value);
	}

	void ULowEntryJsonLibrary::Array_SetJsonValue(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonValue* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonArray::SetJsonValueUnsafe(JsonArray, Index, Value);
			return;
		}
	...
	void ULowEntryJsonLibrary::Array_InsertJsonObject(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonObject* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonArray::InsertJsonObjectUnsafe(JsonArray, Index, Value);
			return;
		}
		ULowEntryJsonArray::InsertJsonObject(JsonArray, Index, Value);
	}

	void ULowEntryJsonLibrary::Array_InsertJsonArray(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonArray* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonArray::InsertJsonArrayUnsafe(JsonArray, Index, Value);
			return;
		}
		ULowEntryJsonArray::InsertJsonArray(JsonArray, Index, Value);
	}

	void ULowEntryJsonLibrary::Array_InsertJsonValue(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonValue* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonArray::InsertJsonValueUnsafe(JsonArray, Index, Value);
			return;
		}
...
// value >>
	...
	ULowEntryJsonValue* ULowEntryJsonLibrary::Value_CreateFromJsonObject(ULowEntryJsonObject* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			return ULowEntryJsonValue::CreateFromJsonObjectUnsafe(Value);
		}
		return ULowEntryJsonValue::CreateFromJsonObject(Value);
	}

	ULowEntryJsonValue* ULowEntryJsonLibrary::Value_CreateFromJsonArray(ULowEntryJsonArray* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			return ULowEntryJsonValue::CreateFromJsonArrayUnsafe(Value);
		}
	...
	ULowEntryJsonValue* ULowEntryJsonLibrary::Value_Pure_CreateFromJsonObject(ULowEntryJsonObject* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			return ULowEntryJsonValue::CreateFromJsonObjectUnsafe(Value);
	...
	ULowEntryJsonValue* ULowEntryJsonLibrary::Value_Pure_CreateFromJsonArray(ULowEntryJsonArray* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			return ULowEntryJsonValue::CreateFromJsonArrayUnsafe(Value);
	...
	bool ULowEntryJsonLibrary::Value_Equals(ULowEntryJsonValue* JsonValueA, ULowEntryJsonValue* JsonValueB)
	{
		return ULowEntryJsonValue::Equals(JsonValueA, JsonValueB);
	}

	bool ULowEntryJsonLibrary::Value_NotEquals(ULowEntryJsonValue* JsonValueA, ULowEntryJsonValue* JsonValueB)
	{
		return !ULowEntryJsonValue::Equals(JsonValueA, JsonValueB);
	}


	void ULowEntryJsonLibrary::Value_Set(ULowEntryJsonValue* JsonValue, ULowEntryJsonValue* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonValue::SetUnsafe(JsonValue, Value);
			return;
		}
	...
	void ULowEntryJsonLibrary::Value_SetJsonObject(ULowEntryJsonValue* JsonValue, ULowEntryJsonObject* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonValue::SetJsonObjectUnsafe(JsonValue, Value);
			return;
		}
		ULowEntryJsonValue::SetJsonObject(JsonValue, Value);
	}

	void ULowEntryJsonLibrary::Value_SetJsonArray(ULowEntryJsonValue* JsonValue, ULowEntryJsonArray* Value, const bool Unsafe)
	{
		if(Unsafe)
		{
			ULowEntryJsonValue::SetJsonArrayUnsafe(JsonValue, Value);
			return;
		}
