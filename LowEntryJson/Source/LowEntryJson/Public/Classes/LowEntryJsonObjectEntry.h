...
public:
	...
	static ULowEntryJsonObjectEntry* CreateFromJsonObjectUnsafe(const FString& Key, ULowEntryJsonObject* Value);
	static ULowEntryJsonObjectEntry* CreateFromJsonArray(const FString& Key, ULowEntryJsonArray* Value);
	static ULowEntryJsonObjectEntry* CreateFromJsonArrayUnsafe(const FString& Key, ULowEntryJsonArray* Value);
