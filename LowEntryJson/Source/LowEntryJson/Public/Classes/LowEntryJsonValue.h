...
public:
	...
	static ULowEntryJsonValue* CreateUnsafe(const TSharedPtr<FJsonValue> Value);
	...
	static ULowEntryJsonValue* CreateFromJsonObjectUnsafe(ULowEntryJsonObject* Value);
	static ULowEntryJsonValue* CreateFromJsonArray(ULowEntryJsonArray* Value);
	static ULowEntryJsonValue* CreateFromJsonArrayUnsafe(ULowEntryJsonArray* Value);
...
public:
	...
	static bool FJsonValueEquals(FJsonValue* ValueA, FJsonValue* ValueB);
	static bool Equals(ULowEntryJsonValue* JsonValueA, ULowEntryJsonValue* JsonValueB);

	static void Set(ULowEntryJsonValue* JsonValue, ULowEntryJsonValue* Value);
	static void SetUnsafe(ULowEntryJsonValue* JsonValue, ULowEntryJsonValue* Value);
	...
	static void SetJsonObjectUnsafe(ULowEntryJsonValue* JsonValue, ULowEntryJsonObject* Value);
	static void SetJsonArray(ULowEntryJsonValue* JsonValue, ULowEntryJsonArray* Value);
	static void SetJsonArrayUnsafe(ULowEntryJsonValue* JsonValue, ULowEntryJsonArray* Value);
