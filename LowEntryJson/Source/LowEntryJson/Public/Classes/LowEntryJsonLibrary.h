...
public: // Object
	...
	*/
	/*UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Object|Create (Non-Pure)", Meta = (DisplayName = "Create Json Object"))*/
		static ULowEntryJsonObject* Object_Create();

	/**
	* Creates a new Json Object.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Object|Create (Non-Pure)", Meta = (DisplayName = "Create Json Object (Json Object Entry Array)"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Object|Create (Non-Pure)", Meta = (DisplayName = "Clone"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Object|Create (Non-Pure)", Meta = (DisplayName = "Merge"))
	...
	*/
	...
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Object|Create (Pure)", Meta = (BlueprintInternalUseOnly = "true", DisplayName = "Create Json Object (Json Object Entry Array) (Safe)"))
		static ULowEntryJsonObject* Object_Pure_CreateFromObjectEntryArray_Internal_Safe(const TArray<ULowEntryJsonObjectEntry*>& Array);

	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Object|Create (Pure)", Meta = (BlueprintInternalUseOnly = "true", DisplayName = "Create Json Object (Json Object Entry Array) (Unsafe)"))
		static ULowEntryJsonObject* Object_Pure_CreateFromObjectEntryArray_Internal_Unsafe(const TArray<ULowEntryJsonObjectEntry*>& Array);
	...
	*/
	...
	/**
	* Returns true if the two given Json Objects contain the same keys/values, returns false otherwise.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Object|Other", Meta = (CompactNodeTitle = "==", DisplayName = "Equals"))
		static bool Object_Equals(ULowEntryJsonObject* JsonObjectA, ULowEntryJsonObject* JsonObjectB);

	/**
	* Returns true if the two given Json Objects do not contain the same keys/values, returns false otherwise.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Object|Other", Meta = (CompactNodeTitle = "!=", DisplayName = "Not Equals"))
		static bool Object_NotEquals(ULowEntryJsonObject* JsonObjectA, ULowEntryJsonObject* JsonObjectB);
	...
	* A new entry will be created if no entry with the given key yet exists.
	* 
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Object|Field", Meta = (DisplayName = "Set Json Object", AdvancedDisplay = "3"))
		static void Object_SetJsonObject(ULowEntryJsonObject* JsonObject, const FString& Key, ULowEntryJsonObject* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Object|Field", Meta = (DisplayName = "Set Json Array", AdvancedDisplay = "3"))
		static void Object_SetJsonArray(ULowEntryJsonObject* JsonObject, const FString& Key, ULowEntryJsonArray* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Object|Field", Meta = (DisplayName = "Set Json Value", AdvancedDisplay = "3"))
		static void Object_SetJsonValue(ULowEntryJsonObject* JsonObject, const FString& Key, ULowEntryJsonValue* Value, const bool Unsafe = false);
...
public: // Object Entry
	...
	*/
	...
	/**
	* Returns the key of the given Json Object Entry.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Object|Entry", Meta = (DisplayName = "Get Key"))
		static FString ObjectEntry_GetKey(ULowEntryJsonObjectEntry* JsonObjectEntry);

	/**
	* Returns the value of the given Json Object Entry.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Object|Entry", Meta = (DisplayName = "Get Value"))
		static ULowEntryJsonValue* ObjectEntry_GetValue(ULowEntryJsonObjectEntry* JsonObjectEntry);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Object|Create Entry (Pure)", Meta = (DisplayName = "Create Json Object Entry (Json Object)", AdvancedDisplay = "2"))
		static ULowEntryJsonObjectEntry* ObjectEntry_Pure_CreateFromJsonObject(const FString& Key, ULowEntryJsonObject* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Object|Create Entry (Pure)", Meta = (DisplayName = "Create Json Object Entry (Json Array)", AdvancedDisplay = "2"))
		static ULowEntryJsonObjectEntry* ObjectEntry_Pure_CreateFromJsonArray(const FString& Key, ULowEntryJsonArray* Value, const bool Unsafe = false);
...
public: // Array
	...
	*/
	/*UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Create (Non-Pure)", Meta = (DisplayName = "Create Json Array"))*/
		static ULowEntryJsonArray* Array_Create();

	/**
	* Creates a new Json Array and fills it with the given Strings.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Create (Non-Pure)", Meta = (DisplayName = "Create Json Array (String Array)"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Create (Non-Pure)", Meta = (DisplayName = "Create Json Array (Integer Array)"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Create (Non-Pure)", Meta = (DisplayName = "Create Json Array (Float Array)"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Create (Non-Pure)", Meta = (DisplayName = "Create Json Array (Byte Array)"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Create (Non-Pure)", Meta = (DisplayName = "Create Json Array (Boolean Array)"))
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Create (Non-Pure)", Meta = (DisplayName = "Create Json Array (Json Object Array)", AdvancedDisplay = "1"))
		static ULowEntryJsonArray* Array_CreateFromJsonObjectArray(const TArray<ULowEntryJsonObject*>& Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Create (Non-Pure)", Meta = (DisplayName = "Create Json Array (Json Array Array)", AdvancedDisplay = "1"))
		static ULowEntryJsonArray* Array_CreateFromJsonArrayArray(const TArray<ULowEntryJsonArray*>& Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Create (Non-Pure)", Meta = (DisplayName = "Create Json Array (Json Value Array)", AdvancedDisplay = "1"))
		static ULowEntryJsonArray* Array_CreateFromJsonValueArray(const TArray<ULowEntryJsonValue*>& Value, const bool Unsafe = false);

	/**
	* Creates a new Json Array and fills it with a copy of the data from the given Json Array.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Create (Non-Pure)", Meta = (DisplayName = "Clone"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Create (Non-Pure)", Meta = (DisplayName = "Merge"))
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Array|Create (Pure)", Meta = (DisplayName = "Create Json Array (Json Object Array)", AdvancedDisplay = "1"))
		static ULowEntryJsonArray* Array_Pure_CreateFromJsonObjectArray(const TArray<ULowEntryJsonObject*>& Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Array|Create (Pure)", Meta = (DisplayName = "Create Json Array (Json Array Array)", AdvancedDisplay = "1"))
		static ULowEntryJsonArray* Array_Pure_CreateFromJsonArrayArray(const TArray<ULowEntryJsonArray*>& Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Array|Create (Pure)", Meta = (DisplayName = "Create Json Array (Json Value Array)", AdvancedDisplay = "1"))
		static ULowEntryJsonArray* Array_Pure_CreateFromJsonValueArray(const TArray<ULowEntryJsonValue*>& Value, const bool Unsafe = false);

	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Array|Create (Pure)", Meta = (BlueprintInternalUseOnly = "true", DisplayName = "Create Json Array (Json Value Array) (Safe)"))
		static ULowEntryJsonArray* Array_Pure_CreateFromJsonValueArray_Internal_Safe(const TArray<ULowEntryJsonValue*>& Value);

	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Array|Create (Pure)", Meta = (BlueprintInternalUseOnly = "true", DisplayName = "Create Json Array (Json Value Array) (Unsafe)"))
		static ULowEntryJsonArray* Array_Pure_CreateFromJsonValueArray_Internal_Unsafe(const TArray<ULowEntryJsonValue*>& Value);
	...
	*/
	...
	/**
	* Returns true if the two given Json Arrays contain the same values (in the same order), returns false otherwise.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Array|Other", Meta = (CompactNodeTitle = "==", DisplayName = "Equals"))
		static bool Array_Equals(ULowEntryJsonArray* JsonArrayA, ULowEntryJsonArray* JsonArrayB);

	/**
	* Returns true if the two given Json Arrays do not contain the same values (in the same order), returns false otherwise.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Array|Other", Meta = (CompactNodeTitle = "!=", DisplayName = "Not Equals"))
		static bool Array_NotEquals(ULowEntryJsonArray* JsonArrayA, ULowEntryJsonArray* JsonArrayB);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Field", Meta = (DisplayName = "Add Json Object", AdvancedDisplay = "2"))
		static void Array_AddJsonObject(ULowEntryJsonArray* JsonArray, ULowEntryJsonObject* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Field", Meta = (DisplayName = "Add Json Array", AdvancedDisplay = "2"))
		static void Array_AddJsonArray(ULowEntryJsonArray* JsonArray, ULowEntryJsonArray* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Field", Meta = (DisplayName = "Add Json Value", AdvancedDisplay = "2"))
		static void Array_AddJsonValue(ULowEntryJsonArray* JsonArray, ULowEntryJsonValue* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Field", Meta = (DisplayName = "Set Json Object", AdvancedDisplay = "3"))
		static void Array_SetJsonObject(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonObject* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Field", Meta = (DisplayName = "Set Json Array", AdvancedDisplay = "3"))
		static void Array_SetJsonArray(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonArray* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Field", Meta = (DisplayName = "Set Json Value", AdvancedDisplay = "3"))
		static void Array_SetJsonValue(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonValue* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Field", Meta = (DisplayName = "Insert Json Object", AdvancedDisplay = "3"))
		static void Array_InsertJsonObject(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonObject* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Field", Meta = (DisplayName = "Insert Json Array", AdvancedDisplay = "3"))
		static void Array_InsertJsonArray(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonArray* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Array|Field", Meta = (DisplayName = "Insert Json Value", AdvancedDisplay = "3"))
		static void Array_InsertJsonValue(ULowEntryJsonArray* JsonArray, const int32 Index, ULowEntryJsonValue* Value, const bool Unsafe = false);
...
public: // Value
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Create (Non-Pure)", Meta = (DisplayName = "Create Json Value"))
		static ULowEntryJsonValue* Value_Create();

	/**
	* Creates a new Json Value and sets its value to null.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Create (Non-Pure)", Meta = (DisplayName = "Create Json Value (Null)"))
		static ULowEntryJsonValue* Value_CreateFromNull();

	/**
	* Creates a new Json Value and sets its value to the given String.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Create (Non-Pure)", Meta = (DisplayName = "Create Json Value (String)"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Create (Non-Pure)", Meta = (DisplayName = "Create Json Value (Integer)"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Create (Non-Pure)", Meta = (DisplayName = "Create Json Value (Float)"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Create (Non-Pure)", Meta = (DisplayName = "Create Json Value (Byte)"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Create (Non-Pure)", Meta = (DisplayName = "Create Json Value (Boolean)"))
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Create (Non-Pure)", Meta = (DisplayName = "Create Json Value (Json Object)", AdvancedDisplay = "1"))
		static ULowEntryJsonValue* Value_CreateFromJsonObject(ULowEntryJsonObject* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Create (Non-Pure)", Meta = (DisplayName = "Create Json Value (Json Array)", AdvancedDisplay = "1"))
		static ULowEntryJsonValue* Value_CreateFromJsonArray(ULowEntryJsonArray* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Create (Non-Pure)", Meta = (DisplayName = "Clone"))
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Value|Create (Pure)", Meta = (DisplayName = "Create Json Value (Json Object)", AdvancedDisplay = "1"))
		static ULowEntryJsonValue* Value_Pure_CreateFromJsonObject(ULowEntryJsonObject* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Value|Create (Pure)", Meta = (DisplayName = "Create Json Value (Json Array)", AdvancedDisplay = "1"))
		static ULowEntryJsonValue* Value_Pure_CreateFromJsonArray(ULowEntryJsonArray* Value, const bool Unsafe = false);
	...
	*/
	...
	/**
	* Returns true if the two given Json Values have the same value, returns false otherwise.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Value|Value", Meta = (CompactNodeTitle = "==", DisplayName = "Equals"))
		static bool Value_Equals(ULowEntryJsonValue* JsonValueA, ULowEntryJsonValue* JsonValueB);

	/**
	* Returns true if the two given Json Values do not have the same value, returns false otherwise.
	*/
	UFUNCTION(BlueprintPure, Category = "Low Entry|Json|Value|Value", Meta = (CompactNodeTitle = "!=", DisplayName = "Not Equals"))
		static bool Value_NotEquals(ULowEntryJsonValue* JsonValueA, ULowEntryJsonValue* JsonValueB);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Value", Meta = (DisplayName = "Set Json Value", AdvancedDisplay = "2"))
		static void Value_Set(ULowEntryJsonValue* JsonValue, ULowEntryJsonValue* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Value", Meta = (DisplayName = "Set Json Object", AdvancedDisplay = "2"))
		static void Value_SetJsonObject(ULowEntryJsonValue* JsonValue, ULowEntryJsonObject* Value, const bool Unsafe = false);
	...
	* Turning "Unsafe" to true will cause the given Value to not be copied before being used by this blueprint. This will offer better performance, but can cause unexpected behavior if you're still using the given Value after this blueprint has run.
	*/
	UFUNCTION(BlueprintCallable, Category = "Low Entry|Json|Value|Value", Meta = (DisplayName = "Set Json Array", AdvancedDisplay = "2"))
		static void Value_SetJsonArray(ULowEntryJsonValue* JsonValue, ULowEntryJsonArray* Value, const bool Unsafe = false);
